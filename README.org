...
***** TODO create css for main-containers			     :design:
       ...
       :Assigned_to: kordano
       :END:
***** TODO add blog post about widget definitions and data model    :writing:
       DEADLINE: <2015-07-30 Do>
       :PROPERTIES:
       :Created: [2015-07-23 Do 11:48]
       :Assigned_to: jeth64
       :END:
***** TODO define clojure structures and functions for summary, input and table widget :design:
       DEADLINE: <2015-07-30 Do>
       :PROPERTIES:
